        ...
        <section className={styles.ours_services}>
          <div>
            <div className={styles.ours_services_info}>
              ...
              <p>
                Nós estamos aqui para ajudar você a acessar todos os serviços de
                streaming que vão entreter você e os seus. Os nossos serviços de
                streaming são o lugar onde você pode assistir, ouvir e brincar,
                aqui você estará sempre entretido. Agora você pode assistir seus
                shows favoritos, ouvir suas músicas favoritas ou jogar os mais
                novos jogos com nossa ampla seleção de aplicativos disponíveis.
              </p>
            </div>
